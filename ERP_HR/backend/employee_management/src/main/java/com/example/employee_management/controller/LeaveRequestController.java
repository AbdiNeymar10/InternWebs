...
// @RestController
// @RequestMapping("/api/leave") // Existing base path for leave-related
// operations
// public class LeaveRequestController {

// private static final Logger logger =
// LoggerFactory.getLogger(LeaveRequestController.class);

// private final LeaveRequestService leaveRequestService;
// private final NotificationService notificationService;
// private final LeaveScheduleService leaveScheduleService; // Inject
// LeaveScheduleService
...
// } else {
// logger.warn("LeaveRequest ID {} has a null leaveType object. LEAVE_TYPE_ID
...
// result.put("id", request.getId() != null ? request.getId().toString() :
// null);
...
// // Include department if needed, ensure it's handled if deptId is an object
// or
// // just an ID
// employeeMap.put("department", employee.getDeptId() != null ?
// employee.getDeptId().toString() : null);
// result.put("employee", employeeMap);
// } else {
// logger.warn("LeaveRequest ID {} has a null employee object.",
// request.getId());
// result.put("employee", null); // Or an empty map
// }

// result.put("leaveType", leaveTypeDetails);
// result.put("incidentType", request.getIncidentType() != null ?
// request.getIncidentType() : "N/A");
// result.put("leaveStart", request.getLeaveStart());
// result.put("leaveEnd", request.getLeaveEnd());
// result.put("requestedDays", request.getRequestedDays() != null ?
// request.getRequestedDays() : 0f);
// result.put("dayType", request.getDayType() != null ? request.getDayType() :
// "N/A");
// result.put("description", request.getDescription() != null ?
// request.getDescription() : "");
// result.put("deptStatus", request.getDeptStatus() != null ?
// request.getDeptStatus() : "Pending");
// result.put("hrStatus", request.getHrStatus() != null ? request.getHrStatus()
// : "Pending");
// result.put("approvedDays", request.getApprovedDays() != null ?
// request.getApprovedDays() : 0.0); // Ensure this
// // is double
...
// if (request.getHrStatus() != null &&
// !"Pending".equalsIgnoreCase(request.getHrStatus())) {
// currentOverallStatus = request.getHrStatus(); // HR status is final
// } else if (request.getDeptStatus() != null &&
// !"Pending".equalsIgnoreCase(request.getDeptStatus())) {
...
// }
// }
// result.put("status", currentOverallStatus); // General status for easier
// frontend display
// result.put("employeeId", request.getEmployee() != null ?
// request.getEmployee().getEmpId() : null);
// result.put("leaveTypeId", request.getLeaveType() != null ?
// request.getLeaveType().getId() : null);

// return result;
// }

// private List<Map<String, Object>>
// convertLeaveRequestListToMapList(List<LeaveRequest> requests) {
...
// @PostMapping("/request")
// public ResponseEntity<?> createLeaveRequest(@RequestBody LeaveRequestDTO
// leaveRequestDTO) {
// try {
// LeaveRequest createdRequest =
// leaveRequestService.createLeaveRequest(leaveRequestDTO);
// return
// ResponseEntity.status(HttpStatus.CREATED).body(convertLeaveRequestToMap(createdRequest));
// } catch (ResourceNotFoundException ex) {
// logger.error("Resource not found while creating leave request: {}",
// ex.getMessage());
// return ResponseEntity.status(HttpStatus.NOT_FOUND)
// .body(Map.of("message", ex.getMessage(), "status", "error"));
// } catch (IllegalArgumentException ex) {
// logger.error("Illegal argument while creating leave request: {}",
// ex.getMessage());
...
// employeeData.put("department", employee.getDeptId() != null ?
// employee.getDeptId().toString() : null);
...
// public ResponseEntity<?> getLeaveRequestsByEmployee(@PathVariable String
// empId) {
// try {
// logger.info("Fetching leave requests for employee ID: {}", empId);
// List<LeaveRequest> requests =
// leaveRequestService.getLeaveRequestsByEmployee(empId);
// if (requests == null) {
// logger.warn("LeaveRequestService returned null for empId: {}", empId);
// return ResponseEntity.ok(Collections.emptyList());
// }
// logger.info("Found {} leave requests for employee ID: {}", requests.size(),
// empId);
// List<Map<String, Object>> responseData =
// convertLeaveRequestListToMapList(requests);
// return ResponseEntity.ok(responseData);
// } catch (ResourceNotFoundException ex) {
// logger.warn("Resource not found when fetching leave requests for empId {}:
// {}", empId, ex.getMessage());
// return ResponseEntity.status(HttpStatus.NOT_FOUND)
// .body(Map.of("message", ex.getMessage(), "status", "error"));
// } catch (Exception ex) {
...
// return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
// .body(Map.of("message", "Error fetching leave requests: " + errorMessage,
// "status", "error"));
// }
// }
...
// getPendingDepartmentApprovals() {
// try {
// List<LeaveRequest> requests =
// leaveRequestService.getPendingDepartmentApprovals();
...
// return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
// .body(Collections.singletonList(Map.of("error", "Failed to fetch pending
...
// return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
// .body(Collections.singletonList(Map.of("error", "Failed to fetch pending HR
// approvals: "
// + (ex.getMessage() != null ? ex.getMessage() : "Internal Server Error"))));
// }
// }
...
// public ResponseEntity<List<Map<String, Object>>>
// getApprovedAndCurrentOrUpcomingLeaves() {
// try {
// List<LeaveRequest> onLeave =
// leaveRequestService.getApprovedAndCurrentOrUpcomingLeaves();
...
// return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
// .body(Collections.singletonList(Map.of("error", "Error fetching employees on
// leave: "
// + (ex.getMessage() != null ? ex.getMessage() : "Internal Server Error"))));
// }
// }
...
// } catch (ResourceNotFoundException ex) {
// logger.warn("Leave request not found for department approval (ID {}): {}",
// requestId, ex.getMessage());
// return ResponseEntity.status(HttpStatus.NOT_FOUND)
// .body(Map.of("message", ex.getMessage(), "status", "error"));
// } catch (IllegalArgumentException ex) {
// logger.warn("Invalid argument for department approval (ID {}): {}",
// requestId, ex.getMessage());
// return ResponseEntity.status(HttpStatus.BAD_REQUEST)
// .body(Map.of("message", ex.getMessage(), "status", "error"));
// } catch (Exception ex) {
// logger.error("Error updating department status for request ID {}", requestId,
// ex);
// return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
// .body(Map.of("message",
...
// return ResponseEntity.ok(convertLeaveRequestToMap(request));
// } catch (ResourceNotFoundException ex) {
// logger.warn("Leave request not found for HR approval (ID {}): {}", requestId,
// ex.getMessage());
// return ResponseEntity.status(HttpStatus.NOT_FOUND)
// .body(Map.of("message", ex.getMessage(), "status", "error"));
// } catch (IllegalArgumentException ex) {
// logger.warn("Invalid argument for HR approval (ID {}): {}", requestId,
// ex.getMessage());
// return ResponseEntity.status(HttpStatus.BAD_REQUEST)
// .body(Map.of("message", ex.getMessage(), "status", "error"));
// } catch (Exception ex) {
...
// public ResponseEntity<List<Map<String, Object>>>
// getDepartmentProcessedHistory() {
// try {
// List<LeaveRequest> history =
// leaveRequestService.getDepartmentProcessedHistory();
...
// return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
// .body(Collections.singletonList(Map.of("error", "Error fetching department
// history: "
// + (ex.getMessage() != null ? ex.getMessage() : "Internal Server Error"))));
// }
// }
...
// getEmployeeLeaveSchedules(@PathVariable String employeeId) {
...
// }
// try {
// List<LeaveScheduleDTO> schedules =
// leaveScheduleService.getLeaveSchedulesByEmployeeId(employeeId);
// if (schedules.isEmpty()) {
// logger.info(
// "No leave schedules found for employee {} via LeaveRequestController.
...
// "data", List.of()));
// }
// logger.info("Found {} leave schedules for employee {} via
// LeaveRequestController", schedules.size(),
// employeeId);
// return ResponseEntity.ok()
// .contentType(MediaType.APPLICATION_JSON)
...
// } catch (Exception e) {
// logger.error(
// "Error fetching leave schedules for employeeId {} via LeaveRequestController:
// Type: {}, Message: {}",
// employeeId, e.getClass().getName(), e.getMessage(), e);
// String errorMessage = "An unexpected error occurred while fetching leave
// schedules.";
...
// public ResponseEntity<?> notifyLeaveSubmission(@RequestBody
// EmailNotificationRequestDTO emailDetails) {
// try {
// notificationService.sendLeaveSubmissionNotification(emailDetails);
// return ResponseEntity.ok(Map.of("status", "success", "message", "Email
// notification request processed."));
// } catch (Exception e) {
// logger.error("Error processing email notification request for submission",
// e);
// return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
// .body(Map.of("status", "error", "message", "Failed to process email
