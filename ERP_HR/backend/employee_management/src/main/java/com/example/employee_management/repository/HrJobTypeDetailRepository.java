...
import com.example.employee_management.entity.HrJobType; // ADDED
...
public interface HrJobTypeDetailRepository extends JpaRepository<HrJobTypeDetail, Long> {
    ...
    // Method to find records by JOB_TYPE_ID (which is now HrJobType entity)
    List<HrJobTypeDetail> findByHrJobType(HrJobType hrJobType); // MODIFIED: Changed parameter type
