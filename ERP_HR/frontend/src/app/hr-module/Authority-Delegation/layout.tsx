...
import Sidebar from "../sidbar"; // Corrected path from 'sidbar' to 'sidebar'

// Define a constant for the breakpoint for easier maintenance
const MOBILE_BREAKPOINT = 640;

export default function AuthorityDelegationLayout({
  children,
}: {
  children: ReactNode;
}) {
    ...
    <div className="flex flex-col h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex flex-1 flex-col sm:flex-row min-h-0">
        ...
        <aside ref={sidebarRef} className="flex flex-col">
          {/* THE FIX: Pass the required 'isMobile' prop */}
          <Sidebar
            isMobile={isMobile}
